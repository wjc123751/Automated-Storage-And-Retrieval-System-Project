...
-- ----------------------------
DROP DATABASE IF EXISTS `laopaoer`;
CREATE DATABASE `laopaoer`;
USE `laopaoer`;
...
-- Records of object
-- ----------------------------
INSERT INTO `object` VALUES ('测试', '000', 1, 0, 1, '2022-12-05 00:53:57');
INSERT INTO `object` VALUES ('显卡', '001', 1, 2, 1, '2022-12-05 00:32:03');
...
INSERT INTO `object` VALUES ('网卡', '012', 1, 1, 1, '2022-12-05 00:25:08');
